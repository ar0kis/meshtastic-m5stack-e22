...
class MyMesh : public mesh::Mesh, public CommonCLICallbacks
{
    ...
    mesh::GroupChannel weather_channel;
    unsigned long last_weather_reply_at;

    bool isWeatherCommand(const char *text) const;
    void sendWeatherReply(const mesh::GroupChannel &channel, const mesh::Packet *request, uint32_t request_timestamp);
#endif
  ...
  public:
    ...
    int getQueueSize() override { return bridge.getQueueSize(); }
#endif
